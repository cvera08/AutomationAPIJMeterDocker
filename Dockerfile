...
# 2 Set JMeter version 5.2.1 for downloading and some ENV variables
...
# 3 Update, upgrade, download Java JRE and JMeter then decompress it
RUN apk update \
	&& apk upgrade \
...
# 4 Copy entrypoint to the container 
COPY entrypoint.sh /
